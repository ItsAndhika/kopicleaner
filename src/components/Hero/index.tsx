const Hero = () => {
  return (
    <section className="container flex flex-col mt-10 mb-10 gap-3">
        <h1 className="text-3xl font-bold tracking-tighter">Elevate Your Coffee Experience with Kopicleaner</h1>
        <p className="text-secondary-foreground font-spacemono">Kopicleaner offers a premium selection of specialty coffee beans, expertly roasted to bring out the best flavors and aromas. Discover the perfect cup for your morning ritual.</p>
