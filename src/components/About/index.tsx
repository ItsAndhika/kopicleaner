...
const About = () => {
  return (
    <section id="about" className="container flex flex-col text-center mt-20 gap-5 p-10">
        ...
        <h1 className="text-3xl font-bold font-dmsans sm:text-4xl">Crafting the Perfect Cup, One Bean at a Time</h1>
        <p className="font-spacemono sm:text-lg">At Kopicleaner, we are passionate about sourcing and roasting the finest specialty coffee beans from around the world. Our team of experienced roasters and baristas work tirelessly to ensure every cup of Kopicleaner is a true delight for the senses. From the rich aroma to the smooth, balanced flavor, we are committed to delivering an exceptional coffee experience with every sip.</p>
